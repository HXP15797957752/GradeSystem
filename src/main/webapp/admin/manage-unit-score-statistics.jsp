...
<head>
  ...
  <title>管理服务领导班子(单位)年度评分统计</title>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12">
        ...
        <table id="excel" class="am-table am-table-bordered am-table-radius am-table-striped">
          ...
          <tr>
            <th rowspan="2">得分</th><th rowspan="2">折算得分(20%)</th><th colspan="4">综合评价票数</th><th colspan="2">群众评分</th><th colspan="4">综合评价票数</th><th colspan="2">群众评分</th>
          </tr>
          <tr>
            <th>好(90分)</th><th>较好(75分)</th><th>一般(60分)</th><th>较差(40分)</th><th>得分</th><th>折算得分(20%)</th>
            <th>好(90分)</th><th>较好(75分)</th><th>一般(60分)</th><th>较差(40分)</th><th>得分</th><th>折算得分(40%)</th>
