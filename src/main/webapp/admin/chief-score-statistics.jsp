    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12">
        ...
        <table class="am-table am-table-bordered am-table-radius am-table-striped">
          <thead>
          <tr>
            <th rowspan="3"><input type="checkbox" name="option1"/></th><th rowspan="3">序号</th><th rowspan="3">单位名称</th><th rowspan="3">干部名称</th><th colspan="6">单位内部测评</th><th colspan="6">学校民主测评</th><th rowspan="2" colspan="2">年度本单位考核得分</th><th colspan="2">校领导评分</th><th rowspan="3">个人考核总得分</th>
          </tr>
          <tr>
