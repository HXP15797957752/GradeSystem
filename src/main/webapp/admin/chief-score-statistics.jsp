...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">正职</strong> / <small>评分统计</small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12">
      	<hr/>
      	<button id="btnexcle" type="submit" class="am-btn am-btn-primary am-btn-xs">导出表格</button>
        <table id="excel" class="am-table am-table-bordered am-table-radius am-table-striped">
          <thead>
          <tr>
            <th rowspan="3">序号</th><th rowspan="3">单位名称</th><th rowspan="3">干部名称</th><th colspan="6">单位内部测评</th><th colspan="6">学校民主测评</th><th rowspan="2" colspan="2">年度本单位考核得分</th><th colspan="2">校领导评分</th><th rowspan="3">个人考核总得分</th>
          </tr>
          <tr>
            <th colspan="4">综合票价票数</th><th colspan="2">群众评分</th><th colspan="4">综合评价票数</th><th colspan="2">群众评分</th><th rowspan="2">得分</th><th rowspan="2">折算得分(20%)</th>
          </tr>
          <tr>
            <th>好(90分)</th><th>较好(75分)</th><th>一般(60分)</th><th>较差(40分)</th><th>得分</th><th>折算得分(30%)</th>
            <th>好(90分)</th><th>较好(75分)</th><th>一般(60分)</th><th>较差(40分)</th><th>得分</th><th>折算得分(20%)</th>
            <th>得分</th><th>折算得分(30%)</th>
          </tr>
          </thead>
          <tbody id="tbo">
...
<script>
		$("#btnexcle").click(function(){
			console.log(1)
			$("#excel").table2excel({
		        exclude: ".noExl",
		        name: "Excel Document Name",
		        filename: "${year}正职考核评分表",
		        exclude_img: true,
		        exclude_links: true,
		        exclude_inputs: true
		    });
