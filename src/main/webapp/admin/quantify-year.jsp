...
<div class="admin-content">
  ...
  <div class="am-tabs am-margin" data-am-tabs>
    <ul class="am-tabs-nav am-nav am-nav-tabs">
      <li class="am-active"><a href="#tab1">${year }年单位定量得分</a></li>
    </ul>
    ...
    <div class="am-tabs-bd">
      ...
      <div class="am-tab-panel am-fade am-in am-active" id="tab1">
		        ...
		        <table class="am-table am-table-bordered am-table-radius am-table-striped">
		          <thead>
		          <tr>
		            <th>序号</th><th>年份</th><th>单位</th><th>分数</th>
		          </tr>
		          </thead>
		          <tbody>
			          <c:forEach items="${quantifyYears}" var="quantifyYear">
		          	  <tr>
		          	    <td><input type="text" style="width:100%;border:none;"placeholder="请输入" name="departmentId" value="${quantifyYear.id}"></td>
			          	<td><input type="text" style="width:100%;border:none;"placeholder="请输入" name="departmentName" value="${quantifyYear.year}"></td>
			          	<td><input type="text" style="width:100%;border:none;"placeholder="请输入" name="departmentId" value="${quantifyYear.departmentName}"></td>
			            <td><input type="text" style="width:100%;border:none;"placeholder="请输入" name="departmentId" value="${quantifyYear.sumGrade}"></td>
			          </tr>	
		          	</c:forEach>	
